...
describe('Page Model', () => {
    ...
    it('should create a page with required fields', async () => {
        ...
        const page = await Page_1.Page.create(pageData);
    ...
    it('should create a page with choices', async () => {
        ...
        await page1.save();
        const updatedPage1 = await Page_1.Page.findById(page1._id);
    ...
    it('should create an ending page with endingType', async () => {
        const endingPage = await Page_1.Page.create({
            storyId: testStory._id.toString(),
    ...
    it('should support image field', async () => {
        const pageWithImage = await Page_1.Page.create({
            storyId: testStory._id.toString(),
    ...
    it('should require storyId and content', async () => {
        ...
        await expect(Page_1.Page.create(invalidPage)).rejects.toThrow();
    });
});
