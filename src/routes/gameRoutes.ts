...
import { startGame, makeChoice, getSessions, getSession, getPathStats, getStoryStats, getSessionByStory } from '../controllers/gameController';
...
router.get('/session/by-story/:storyId', authenticate, getSessionByStory);
