...
export class StoryGenerator {
     ...
     */
    private async generateStoryMetadata(userPrompt: string, language: string): Promise<{
        title: string;
        description: string;
        tags: string[];
        theme: string;
     ...
     */
    async suggestChoices(request: ChoiceSuggestionRequest): Promise<GeneratedChoice[]> {
